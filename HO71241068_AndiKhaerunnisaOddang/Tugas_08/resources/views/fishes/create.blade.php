...
<div class="mb-4">
    <h2>Add New Fish</h2>
    <p class="text-muted">Fill in the details to add a new fish to the database</p>
</div>
        ...
        <form method="POST" action="{{ route('fishes.store') }}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          placeholder="Enter fish description (optional)...">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary px-4">Save Fish</button>
