...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Tambah Gudang Baru</h1>
        ...
        <form action="{{ route('warehouses.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="location" 
                          ...
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('location') }}</textarea>
            </div>
